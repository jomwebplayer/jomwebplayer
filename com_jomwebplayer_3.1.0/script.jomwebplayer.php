...
class Com_JomWebplayerInstallerScript {
	...
	function postflight($type, $parent) {
		...
		if ($num==0) {
			$query = "INSERT INTO `#__jomwebplayer_videos` (`id`, `title`, `type`, `streamer`, `video`, `preview`, `thumb`, `category`, `published`) VALUES (NULL, 'Sample Video', 'Direct URL', '', 'http://jomwebplayer.com/player/videos/300.mp4', 'http://img.youtube.com/vi/HdNn5TZu6R8/0.jpg', 'http://img.youtube.com/vi/HdNn5TZu6R8/0.jpg', 'none', '1')";
			$db->setQuery($query);
			$db->Query();
